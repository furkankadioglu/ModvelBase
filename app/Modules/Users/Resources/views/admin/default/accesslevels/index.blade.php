    ...
    <div class="block-content">
        <table class="table table-bordered table-striped js-dataTable-full">
            ...
            <tr>
                ...
                <td>{{ $data->levelPoint }}</td>
                <td class="text-center">
                    <div class="btn-group">
                        <a class="btn btn-xs btn-default" href="{{ url('admin/modules/Users/accesslevels/'.$data->id.'/edit') }}" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                        <a class="btn btn-xs btn-default confirm" href="{{ url('admin/modules/Users/accesslevels/'.$data->id.'/delete') }}" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></a>
                    </div>
                </td>
            </tr>
            @endforeach
