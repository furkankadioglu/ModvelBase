...
@section('content')
<form action="{{ url('/admin/modules/Users/informations') }}" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
            ...
            <div class="col-md-8 col-md-offset-2">
	            <div class="form-group">
	                    <div class="form-material floating">
	                        <input class="form-control" id="material-text2" name="templateName" type="text">
