...
@section('content')
<form action="{{ url('/admin/modules/Users/settings') }}" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
<input name="_method" type="hidden" value="PUT" />
<div class="block block-bordered">
    <div class="block-header bg-gray-lighter">
   	 	<ul class="block-options">
           @include('Users::admin.settingsNavigation')
        </ul>
   ...
   <div class="block-content push-10-t form-horizontal">
      ...
      @else
        ...
        <div class="form-group">
                ...
                <div class="pull-right"><a href="{{ url('admin/modules/Users/settings/'.$setting->id.'/delete') }}" class="confirm"><span class="fa fa-trash"></span></a></div>
        </div>
        @endforeach
      @endif
