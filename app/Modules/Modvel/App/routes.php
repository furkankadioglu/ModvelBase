...
Route::group(array('module' => 'Modvel', 'middleware' =>  ['web', 'auth'], 'namespace' => 'App\Modules\Modvel\App\Http\Controllers'), function() {
    ...
    Route::get('/admin/modules/Modvel/modules/{id}_{name}/delete', array('uses' => '\App\Modules\Modvel\App\Http\Controllers\ModvelModulesAdminController@destroy', 'as' => 'admin.Modvel.modules.destroy'));
    Route::get('/admin/modules/Modvel/modules/functions/{functionName}', array('uses' => '\App\Modules\Modvel\App\Http\Controllers\ModvelModulesAdminController@functions', 'as' => 'admin.Modvel.modules.function'));
