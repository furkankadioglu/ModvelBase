...
class BaseHelpers {
	...
	{
		return ModvelModule::where('adminVisible', 1)->groupBy('category')->get(['category']);
	}

		public static function getMainModuleCategories()
	{
		return ModvelModule::where('displayVisible', 1)->groupBy('category')->get(['category']);
	}
