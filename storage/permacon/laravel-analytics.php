...
return
    ...
    [
         ...
         */
        'clientId' => '6ee0dadca345ec3843e813f6654bac5797aa048a',
         ...
         */
        'serviceEmail' => 'laravel-analytics@thinking-case-670.iam.gserviceaccount.com',

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('laravel-analytics/laravel-analytics.p12'),
